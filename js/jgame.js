...
(function (jg) {
    var MT = (function () {
        ...
        MT._mulUint32 = function _mulUint32(a, b) {
            var a1 = a >> 16, a2 = a & 65535;
            var b1 = b >> 16, b2 = b & 65535;
        ...
        MT.prototype._nextInt = function () {
            ...
            if(this._index >= mt.length) {
                ...
                do {
                    value = (mt[k] & 2147483648) | (mt[k + 1] & 2147483647);
                    mt[k] = mt[k + M] ^ (value >> 1) ^ ((value & 1) ? 2567483615 : 0);
                }while(++k < N - M);
                do {
                    value = (mt[k] & 2147483648) | (mt[k + 1] & 2147483647);
                    mt[k] = mt[k + M - N] ^ (value >> 1) ^ ((value & 1) ? 2567483615 : 0);
                }while(++k < N - 1);
                value = (mt[N - 1] & 2147483648) | (mt[0] & 2147483647);
                mt[N - 1] = mt[M - 1] ^ (value >> 1) ^ ((value & 1) ? 2567483615 : 0);
                this._index = 0;
            }
...
(function (jg) {
    ...
    (function (InputEventAction) {
        InputEventAction._map = [];
        InputEventAction._map[0] = "Unknown";
        InputEventAction.Unknown = 0;
        InputEventAction._map[1] = "Down";
        InputEventAction.Down = 1;
        InputEventAction._map[2] = "Move";
        InputEventAction.Move = 2;
        InputEventAction._map[3] = "Up";
        InputEventAction.Up = 3;
...
(function (jg) {
    ...
    var E = (function () {
        ...
        E.prototype.createSprite = function () {
            var buffer = new jg.BufferedRenderer({
                width: this.width,
                height: this.height
            });
            var x = this.x;
...
(function (jg) {
    var FrameSprite = (function (_super) {
        ...
        FrameSprite.prototype.startTimer = function (noClear) {
            if(this.animation) {
                return true;
            }
            if(!noClear) {
            ...
            this.animation = true;
            _super.prototype.startTimer.call(this, this.wait);
        };
        FrameSprite.prototype.stopTimer = function () {
            if(!this.animation) {
                return;
            }
            _super.prototype.stopTimer.call(this, this.wait);
            this.animation = false;
        };
...
(function (jg) {
    ...
    var EffectScene = (function (_super) {
        ...
        EffectScene.prototype.mosaic = function () {
            var _this = this;
            var t = Effect.time / 2;
            this.sp1.tl().filter(jg.ImageFilter.MosaicFilter, {
                size: {
                    start: 1,
                    end: 64
                }
            }, t).removeFromScene();
            this.sp2.tl().delay(t).show().filter(jg.ImageFilter.MosaicFilter, {
                size: {
                    start: 64,
                    end: 1
                }
        ...
        EffectScene.prototype.blur = function () {
            var _this = this;
            var t = Effect.time / 2;
            this.sp1.tl().filter(jg.ImageFilter.BlurFilter, {
                amount: {
                    start: 1,
                    end: 20
                }
            }, t, jg.Easing.CUBIC_EASEIN).removeFromScene();
            this.sp2.tl().delay(t).show().filter(jg.ImageFilter.BlurFilter, {
                amount: {
                    start: 20,
                    end: 1
                }
            }, t, jg.Easing.CUBIC_EASEOUT).then(function () {
                _this.effected.fire();
            });
        };
        ...
        EffectScene.prototype.universal = function (image, repeat) {
            ...
            var t = Effect.time;
            this.swapScene();
            this.sp1.tl().filter(jg.ImageFilter.UniversalTransitionFilter, {
                image: image,
                repeat: repeat,
                amount: {
                    start: -255,
        ...
        EffectScene.prototype.universalTwin = function (image, repeat) {
            ...
            this.sp2.tl().show().filter(jg.ImageFilter.ReverseUniversalTransitionFilter, {
                image: image,
                repeat: repeat,
                amount: {
                    start: 255,
        ...
        EffectScene.prototype.universalDelay = function (image, repeat, color) {
            ...
            this.sp2.tl().delay(t).show().filter(jg.ImageFilter.UniversalTransitionFilter, {
                image: image,
                repeat: repeat,
                amount: {
                    start: 255,
...
(function (jg) {
    var UIWindow = (function (_super) {
        ...
        UIWindow.prototype.defaultSkin = function () {
            ...
            var bgColor = jg.JGUtil.createLinearGradient(new jg.Rectangle(0, 0, this.width, this.height), [
