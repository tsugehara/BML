...
(function (BML) {
    ...
    var BulletML = (function () {
        ...
        BulletML.startBullet = function (owner, caller, callback, attackPattern, config, game) {
            if (game === undefined)
                game = BulletML.game;
        ...
        BulletML.endBulet = function (owner, game) {
            if (game === undefined)
                game = BulletML.game;
        ...
        BulletML.defaultBulletFactory = function (opt) {
            if (!BulletML.defaultSprite) {
                var gra = jg.JGUtil.createRadialGradient(new jg.Rectangle(4, 4, 4, 4), 0, 4, ["rgba(255,255,255,1.0)", "rgba(255,255,255,1.0)", "rgba(255,0,0,0.8)", "rgba(255,0,0,0.0)"], [0.0, 0.5, 0.8, 1.0]);
        ...
        BulletML.bulletContainerFactory = function (opt) {
        ...
        BulletML.defaultIsInsideOfWorld = function (bullet) {
        ...
        BulletML.normalizeRadian = function (radian) {
        ...
        BulletML.angleAtoB = function (a, b) {
            var ca = {
                x: a.x + (a.width || 0) / 2,
                y: a.y + (a.height || 0) / 2
            };
