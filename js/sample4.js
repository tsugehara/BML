...
window.onload = function() {
	var game = new Game(320, 320, RenderTransferMode.Direct, "WebGLRenderer");
	...
	game.loaded.handle(function() {
		...
		AttackPattern.defaultConfig.bulletFactory = BML.BulletML.bulletContainerFactory;

		var container = new BML.BulletContainer();
		BML.BulletML.container = container;
		AttackPattern.defaultConfig.addTarget = container;
